...
class Main
  ...
  def check_winner
    # winner logic
    @winner = @user if (@croupier.card_points < @user.card_points && @user.card_points < 21) || @croupier.card_points >= 21
    @winner = @croupier if (@croupier.card_points > @user.card_points && @croupier.card_points < 21) || @user.card_points >= 21
